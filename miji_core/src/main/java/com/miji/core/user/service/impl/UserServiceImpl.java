package com.miji.core.user.service.impl;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Result me(Long currentUserId) {
    ...
    @Override
    public Result detail(Long userId, Long currentUserId) {
        checkLoginUser(currentUserId);
        if (userId == null) {
            throw new CustomException(HttpServletResponse.SC_BAD_REQUEST, "userId can not be null");
        }
    ...
    private UserDO getActiveUser(Long userId) {
    ...
    private UserDetailVO buildUserDetailVO(UserDO userDO, boolean followed) {
